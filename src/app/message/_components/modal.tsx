...
export default function send({ isOpen, closeModal, id, nickname }: ModalProps) {
                ...
                <div className="grid-cols-1 gap-2">
                    ...
                    {/* <form onSubmit={handleSubmit}> */}
                        <div className="flex col-1 mt-12 ml-28 ">
                            ...
                            <button
                            type="submit"
                            className="bg-black text-white rounded-md py-2 px-4 hover:bg-zinc w-[150px] h-[50px]" onClick={closeModal}>
                            취소
                            </button>
                        </div>
                </div>
